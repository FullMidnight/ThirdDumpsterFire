...
class nmap_top_1000_and_probes( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_top_1000_and_probes"
		return
	...
	def Description( self ):
		self.Description = "Runs nmap, probing Top 1000 ports & services on hosts of target network"
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sC " + self.networkAddrStr 
