...
class nmap_all_65K_TCP_ports( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_all_65K_TCP_ports"
		return
	...
	def Description( self ):
		self.Description = "Runs nmap, probing all 65K ports and discovered services on hosts of target network. Creates lots of network noise."
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sC -p- " + self.networkAddrStr 
