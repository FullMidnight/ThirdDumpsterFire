...
class nmap_top_80_ports( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_top_80_ports"
		return
	...
	def Description( self ):
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sV --top-ports=80 " + self.networkAddrStr 
